...
st.data_editor(coluna_faturado, column_config={coluna_faturado: st.column_config.ProgressColumn("faturamento", format="$%f", min_value=0, max_value=df_filtered["Média Trimestre"],},)
